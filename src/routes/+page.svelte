...
<div class="max-w-7xl mx-auto space-y-6 transition-opacity duration-300">
			...
			<div class="flex items-center justify-between mb-6">
				...
				<div class="flex gap-2">
					...
					<Button
						variant="ghost"
						size="sm"
						class="text-xs text-muted-foreground">6H</Button
					>
					<Button
						variant="ghost"
						size="sm"
						class="text-xs text-muted-foreground">24H</Button
					>
				</div>
			</div>
	...
	<div
		class="glass rounded-2xl border border-border overflow-hidden opacity-60"
	>
		<div
			class="px-6 py-4 border-b border-border flex justify-between items-center bg-secondary/50"
		>
			<div class="flex items-center gap-3">
				...
				<span
					class="text-[0.625rem] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-muted text-muted-foreground"
				>
					Placeholder
				</span>
			</div>
			<span
				class="text-xs text-muted-foreground/50 cursor-not-allowed flex items-center gap-2"
			>
				View Full Console
				<span
					class="text-[0.625rem] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-muted text-muted-foreground"
		...
		<div class="p-4 font-mono text-xs space-y-2 text-muted-foreground">
			...
			<div class="flex gap-3">
				...
				<span
					>Can't keep up! Is the server overloaded? Running 2005ms or
					40 ticks behind</span
				>
			</div>
		</div>
	</div>
